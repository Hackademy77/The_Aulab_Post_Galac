        ...
        <div class="container ">
            <div class="row my-5">
                <div class="col-12 col-md-8">
                    ...
                    <a href="{{route('article.index')}}" class="btn show_button bg-search btn-custom-grey ">More Articles</a>
                </div>
            </div>
            @if (Auth::user() && Auth::user()->is_revisor)
                <a href="{{route('revisor.acceptArticle', compact('article'))}}" class="btn border-0 btn-dark btn-custom-white btn-custom-grey my-5 btn-writer-custom">Accept</a> 
                <a href="{{route('revisor.rejectArticle', compact('article'))}}" class="btn border-0 btn-dark btn-custom-white btn-custom-grey my-5 btn-writer-custom">Reject</a> 
            @endif
        </div>
